...
export const HeroSection = ( props ) => {
  const { section } = props;
  const { background, has_background, title, subtitle, actions, image, image_alt, image_position, align } = section;
  ...
  return (
      <section className={classNames('section', 'hero', {'bg-image': has_background && background_image, 'inverse bg-blue': has_background && (background_color === 'blue'), 'bg-gray': has_background && (background_color === 'gray'), 'section--padding': has_background || image})}>
        ...
        <div className="container container--lg">
          <div className={classNames('flex', 'flex--middle', 'flex--center', 'flex--col-2', {'align-center': align === 'center', 'align-right': align === 'right'})}>
            {image && (
            <div className={classNames('cell', 'section__media', {'section__media--right': image_position === 'right'})}>
